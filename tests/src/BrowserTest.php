...
class BrowserTest extends BaseTest
{
    ...
    {
        $path = dirname(__FILE__) . '/../css';
        $subFolder = 'animation-iteration-count';
    ...
    {
        $path = dirname(__FILE__) . '/../css';
        $subFolder = 'animation-play-state';
    ...
    {
        $path = dirname(__FILE__) . '/../css';
        $subFolder = 'animation-timing-function';
    ...
    {
        $path = dirname(__FILE__) . '/../css';
        $subFolder = 'transition-timing-function';
